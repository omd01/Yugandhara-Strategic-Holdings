  ...
  return (
    <div className="h-screen ">
      ...
      <div className="relative z-10 flex  w-full h-full">
        <div className="h-full flex flex-col border-r border-slate-400">
        ...
        <div className="flex flex-col w-full font-gothicbold ">
          <div className="h-1/2 border-b border-slate-400 flex flex-col justify-end p-11 relative">
            <div
