...
const Contact = () => {
    ...
    <section className="hero-section flex flex-row max-md:flex-col h-auto mt-5 xmlg:pl-28 xmlg:pr-28">
        <div className="container w-[50%] max-md:w-full flex flex-col items-center">
            <div className='max-w-xl '>
                <h1 className='text-4xl max-md:text-2xl font-gothicbold'>Talk to our product analytics expert</h1>
                <p className='font-gothicbook text-md  pt-3'>
                    Have questions on pricing, plans or growthly? Fill out the form and our product
                     analytics expert will be in touch directly.
                </p>
            </div>
            <div className='max-w-xl'>
                <h1 className='text-2xl font-gothicbold pt-2'>Our Office</h1>
                <img src={officeimg} alt="office image" className='w-[70%] h-auto max-md:hidden'/>
        ...
        <form class="max-w-xl mx-auto bg-[#F2F2F2] p-10 max-md:p-5 max-md:rounded-lg rounded-3xl shadow-inner font-gothicdemi">
        <div class="mb-5">
  ...
  <div class="mb-5">
    ...
    <input type="fname" id="fname" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required />
  </div>
  <div class="mb-5">
    <label for="lname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last name</label>
    <input type="lname" id="lname" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="name@flowbite.com" required />
  </div>
  <div class="mb-5">
  ...
  <button type="submit" class="text-white bg-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
</form>
        </div>
    </section>
    </>
